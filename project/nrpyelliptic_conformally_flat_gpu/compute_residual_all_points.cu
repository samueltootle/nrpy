...
/*
 * GPU Kernel: compute_residual_all_points_gpu.
 * GPU Kernel to compute the residual throughout the grid.
 */
__global__ static void compute_residual_all_points_gpu(const REAL *restrict rfm_f0_of_xx0, const REAL *restrict rfm_f0_of_xx0__D0,
  ...
  for (int i2 = tid2 + NGHOSTS; i2 < Nxx_plus_2NGHOSTS2 - NGHOSTS; i2 += stride2) {
    for (int i1 = tid1 + NGHOSTS; i1 < Nxx_plus_2NGHOSTS1 - NGHOSTS; i1 += stride1) {
      ...
      for (int i0 = tid0 + NGHOSTS; i0 < Nxx_plus_2NGHOSTS0 - NGHOSTS; i0 += stride0) {
        ...
        const REAL FDPart1_Rational_5_21 = 5.0 / 21.0;
        const REAL FDPart1_Rational_5_84 = 5.0 / 84.0;
        const REAL FDPart1_Rational_5_504 = 5.0 / 504.0;
        const REAL FDPart1_Rational_1_1260 = 1.0 / 1260.0;
        const REAL FDPart1_Rational_5269_1800 = 5269.0 / 1800.0;
        const REAL FDPart1_Rational_5_1008 = 5.0 / 1008.0;
        const REAL FDPart1_Rational_1_3150 = 1.0 / 3150.0;
        const REAL FDPart1_Rational_5_3 = 5.0 / 3.0;
        const REAL FDPart1_Rational_5_126 = 5.0 / 126.0;
        ...
        aux_gfs[IDX4(RESIDUAL_HGF, i0, i1, i2)] =
...
#include "set_CodeParameters.h"
  ...
  compute_residual_all_points_gpu<<<blocks_per_grid, threads_per_block, sm, streams[streamid]>>>(
      ...
      rfm_f2_of_xx0, rfm_f2_of_xx0__D0, rfm_f2_of_xx0__DD00, rfm_f4_of_xx1, rfm_f4_of_xx1__D1, rfm_f4_of_xx1__DD11, auxevol_gfs, in_gfs, aux_gfs);
