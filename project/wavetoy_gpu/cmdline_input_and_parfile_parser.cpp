...
static void print_usage() {
  fprintf(stderr, "Usage option 0: ./wavetoy_gpu [--help or -h] <- Outputs this usage command\n");
  fprintf(stderr, "Usage option 1: ./wavetoy_gpu <- reads in parameter file wavetoy_gpu.par\n");
  fprintf(stderr, "Usage option 2: ./wavetoy_gpu [parfile] <- reads in parameter file [parfile]\n");
  fprintf(stderr, "Usage option 3: ./wavetoy_gpu [convergence_factor] <- overwrites parameters in list after reading in wavetoy_gpu.par\n");
  fprintf(stderr,
          "Usage option 4: ./wavetoy_gpu [parfile] [convergence_factor] <- overwrites list of steerable parameters after reading in [parfile]\n");
}
...
void cmdline_input_and_parfile_parser(commondata_struct *restrict commondata, int argc, const char *argv[]) {
  ...
  if (argc == 1) {
    option = 1; // Usage option 1: Process default parameter file "wavetoy_gpu.par"
  } else if (argc == 2) {
    ...
    option = 3; // Usage option 3: Overwrite steerable parameters after processing "wavetoy_gpu.par"
  ...
  const char *filename = (option == 1 || option == 3) ? "wavetoy_gpu.par" : argv[1];
