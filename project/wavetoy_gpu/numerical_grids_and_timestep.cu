 ...
 */
__global__
void numerical_grids_and_timestep_gpu(commondata_struct *restrict commondata, 
...
void numerical_grids_and_timestep(commondata_struct *restrict commondata, griddata_struct *restrict griddata, bool calling_for_first_time) {
  numerical_grids_and_timestep_gpu<<<1,1>>>(commondata, griddata, calling_for_first_time);
}
