...
void apply_bcs_outerradiation_and_inner(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                        const bc_struct *restrict bcstruct, float *restrict xx[3], const REAL custom_wavespeed[NUM_EVOL_GFS],
...
void apply_bcs_outerradiation_and_inner__rfm__SinhSymTP(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                                        const bc_struct *restrict bcstruct, float *restrict xx[3],
...
void bcstruct_set_up(const commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                     bc_struct *restrict bcstruct_gpu);
void bcstruct_set_up__rfm__SinhSymTP(const commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                     bc_struct *restrict bcstruct_gpu);
void cfl_limited_timestep(commondata_struct *restrict commondata, params_struct *restrict params, float *restrict xx[3], bc_struct *restrict bcstruct);
void cfl_limited_timestep__rfm__SinhSymTP(commondata_struct *restrict commondata, params_struct *restrict params, float *restrict xx[3],
...
void diagnostics_nearest_1d_y_axis(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                   MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_1d_y_axis__rfm__SinhSymTP(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                                   MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_1d_z_axis(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                   MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_1d_z_axis__rfm__SinhSymTP(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                                   MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_2d_xy_plane(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                     MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_2d_xy_plane__rfm__SinhSymTP(commondata_struct *restrict commondata, const params_struct *restrict params,
                                                     float *restrict xx[3], MoL_gridfunctions_struct *restrict gridfuncs);
void diagnostics_nearest_2d_yz_plane(commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
                                     MoL_gridfunctions_struct *restrict gridfuncs);
...
void rfm_precompute_defines__rfm__SinhSymTP(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                            rfm_struct *restrict rfmstruct, float *restrict xx[3]);
...
void xx_to_Cart(const commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3], const int i0, const int i1,
                const int i2, REAL xCart[3]);
__host__ void xx_to_Cart__rfm__SinhSymTP(const commondata_struct *restrict commondata, const params_struct *restrict params, float *restrict xx[3],
