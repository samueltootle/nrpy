...
int interpolation_3d_general__uniform_src_grid_host(const int INTERP_ORDER, const REAL src_invdxx012_INTERP_ORDERm1,
  ...
  const int NUM_INTERP_GFS, const REAL *restrict src_x0x1x2[3],
  const REAL src_invdxx0, const REAL src_invdxx1, const REAL src_invdxx2,
  const REAL *restrict inv_denom, const REAL *restrict src_gf_ptrs[], REAL *restrict dst_data[]) {
