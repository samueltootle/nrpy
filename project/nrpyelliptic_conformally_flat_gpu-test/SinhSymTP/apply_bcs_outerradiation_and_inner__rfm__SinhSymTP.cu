 ...
 * Compute 1st derivative finite-difference derivative with arbitrary upwind
 */
static inline REAL FD1_arbitrary_upwind_x1_dirn(const commondata_struct *restrict commondata, const params_struct *restrict params,
                                                const REAL *restrict gf, const int i0, const int i1, const int i2, const int offset) {
#include "../set_CodeParameters.h"
  switch (offset) {
  case 0:
    return (-1.0 / 60.0 * gf[IDX3(i0, i1 - 3, i2)] + 3.0 / 20.0 * gf[IDX3(i0, i1 - 2, i2)] - 3.0 / 4.0 * gf[IDX3(i0, i1 - 1, i2)] +
            3.0 / 4.0 * gf[IDX3(i0, i1 + 1, i2)] - 3.0 / 20.0 * gf[IDX3(i0, i1 + 2, i2)] + 1.0 / 60.0 * gf[IDX3(i0, i1 + 3, i2)]) *
           invdxx1;
  case 1:
    return (+1.0 / 30.0 * gf[IDX3(i0, i1 - 2, i2)] - 2.0 / 5.0 * gf[IDX3(i0, i1 - 1, i2)] - 7.0 / 12.0 * gf[IDX3(i0, i1, i2)] +
            4.0 / 3.0 * gf[IDX3(i0, i1 + 1, i2)] - 1.0 / 2.0 * gf[IDX3(i0, i1 + 2, i2)] + 2.0 / 15.0 * gf[IDX3(i0, i1 + 3, i2)] -
            1.0 / 60.0 * gf[IDX3(i0, i1 + 4, i2)]) *
           invdxx1;
  case -1:
    return (+1.0 / 60.0 * gf[IDX3(i0, i1 - 4, i2)] - 2.0 / 15.0 * gf[IDX3(i0, i1 - 3, i2)] + 1.0 / 2.0 * gf[IDX3(i0, i1 - 2, i2)] -
            4.0 / 3.0 * gf[IDX3(i0, i1 - 1, i2)] + 7.0 / 12.0 * gf[IDX3(i0, i1, i2)] + 2.0 / 5.0 * gf[IDX3(i0, i1 + 1, i2)] -
            1.0 / 30.0 * gf[IDX3(i0, i1 + 2, i2)]) *
           invdxx1;
  case 2:
    return (-1.0 / 6.0 * gf[IDX3(i0, i1 - 1, i2)] - 77.0 / 60.0 * gf[IDX3(i0, i1, i2)] + 5.0 / 2.0 * gf[IDX3(i0, i1 + 1, i2)] -
            5.0 / 3.0 * gf[IDX3(i0, i1 + 2, i2)] + 5.0 / 6.0 * gf[IDX3(i0, i1 + 3, i2)] - 1.0 / 4.0 * gf[IDX3(i0, i1 + 4, i2)] +
            1.0 / 30.0 * gf[IDX3(i0, i1 + 5, i2)]) *
           invdxx1;
  case -2:
    return (-1.0 / 30.0 * gf[IDX3(i0, i1 - 5, i2)] + 1.0 / 4.0 * gf[IDX3(i0, i1 - 4, i2)] - 5.0 / 6.0 * gf[IDX3(i0, i1 - 3, i2)] +
            5.0 / 3.0 * gf[IDX3(i0, i1 - 2, i2)] - 5.0 / 2.0 * gf[IDX3(i0, i1 - 1, i2)] + 77.0 / 60.0 * gf[IDX3(i0, i1, i2)] +
            1.0 / 6.0 * gf[IDX3(i0, i1 + 1, i2)]) *
           invdxx1;
  case 3:
    return (-49.0 / 20.0 * gf[IDX3(i0, i1, i2)] + 6 * gf[IDX3(i0, i1 + 1, i2)] - 15.0 / 2.0 * gf[IDX3(i0, i1 + 2, i2)] +
            20.0 / 3.0 * gf[IDX3(i0, i1 + 3, i2)] - 15.0 / 4.0 * gf[IDX3(i0, i1 + 4, i2)] + 6.0 / 5.0 * gf[IDX3(i0, i1 + 5, i2)] -
            1.0 / 6.0 * gf[IDX3(i0, i1 + 6, i2)]) *
           invdxx1;
  case -3:
    return (+1.0 / 6.0 * gf[IDX3(i0, i1 - 6, i2)] - 6.0 / 5.0 * gf[IDX3(i0, i1 - 5, i2)] + 15.0 / 4.0 * gf[IDX3(i0, i1 - 4, i2)] -
            20.0 / 3.0 * gf[IDX3(i0, i1 - 3, i2)] + 15.0 / 2.0 * gf[IDX3(i0, i1 - 2, i2)] - 6 * gf[IDX3(i0, i1 - 1, i2)] +
            49.0 / 20.0 * gf[IDX3(i0, i1, i2)]) *
           invdxx1;
  }
  return 0.0 / 0.0; // poison output if offset computed incorrectly
...
#include "../set_CodeParameters.h"
  ...
  const REAL partial_x1_f = FD1_arbitrary_upwind_x1_dirn(commondata, params, &gfs[which_gf * ntot], dest_i0, dest_i1, dest_i2, i1_offset);
