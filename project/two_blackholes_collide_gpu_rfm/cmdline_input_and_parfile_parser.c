...
static void print_usage() {
  fprintf(stderr, "Usage option 0: ./two_blackholes_collide_nosimd_rfm [--help or -h] <- Outputs this usage command\n");
  fprintf(stderr, "Usage option 1: ./two_blackholes_collide_nosimd_rfm <- reads in parameter file two_blackholes_collide_nosimd_rfm.par\n");
  fprintf(stderr, "Usage option 2: ./two_blackholes_collide_nosimd_rfm [parfile] <- reads in parameter file [parfile]\n");
  fprintf(stderr, "Usage option 3: ./two_blackholes_collide_nosimd_rfm [convergence_factor] <- overwrites parameters in list after reading in "
                  "two_blackholes_collide_nosimd_rfm.par\n");
  fprintf(stderr, "Usage option 4: ./two_blackholes_collide_nosimd_rfm [parfile] [convergence_factor] <- overwrites list of steerable parameters "
...
void cmdline_input_and_parfile_parser(commondata_struct *restrict commondata, int argc, const char *argv[]) {
  ...
  if (argc == 1) {
    option = 1; // Usage option 1: Process default parameter file "two_blackholes_collide_nosimd_rfm.par"
  } else if (argc == 2) {
    ...
    option = 3; // Usage option 3: Overwrite steerable parameters after processing "two_blackholes_collide_nosimd_rfm.par"
  ...
  const char *filename = (option == 1 || option == 3) ? "two_blackholes_collide_nosimd_rfm.par" : argv[1];
  ...
  while (fgets(line, sizeof(line), file)) {
    ...
    if (p) {
      ...
      if (p) {
        ...
        if (1 == 0)
          param_index = -2;
        else if (strcmp(param, "BH1_mass") == 0)
          param_index = 0;
        else if (strcmp(param, "BH1_posn_x") == 0)
          param_index = 1;
        else if (strcmp(param, "BH1_posn_y") == 0)
          param_index = 2;
        else if (strcmp(param, "BH1_posn_z") == 0)
          param_index = 3;
        else if (strcmp(param, "BH2_mass") == 0)
          param_index = 4;
        else if (strcmp(param, "BH2_posn_x") == 0)
          param_index = 5;
        else if (strcmp(param, "BH2_posn_y") == 0)
          param_index = 6;
        else if (strcmp(param, "BH2_posn_z") == 0)
          param_index = 7;
        ...
        if (param_index == -2)
          ...
          read_double(value, &commondata->BH1_mass, "BH1_mass");
        else if (param_index == 1)
          read_double(value, &commondata->BH1_posn_x, "BH1_posn_x");
        else if (param_index == 2)
          read_double(value, &commondata->BH1_posn_y, "BH1_posn_y");
        else if (param_index == 3)
          read_double(value, &commondata->BH1_posn_z, "BH1_posn_z");
        else if (param_index == 4)
          read_double(value, &commondata->BH2_mass, "BH2_mass");
        else if (param_index == 5)
          read_double(value, &commondata->BH2_posn_x, "BH2_posn_x");
        else if (param_index == 6)
          read_double(value, &commondata->BH2_posn_y, "BH2_posn_y");
        else if (param_index == 7)
          read_double(value, &commondata->BH2_posn_z, "BH2_posn_z");
