  ...
  for(size_t i2 = tid2+NGHOSTS; i2 < Nxx2+NGHOSTS; i2 += stride2) {
    for(size_t i1 = tid1+NGHOSTS; i1 < Nxx1+NGHOSTS; i1 += stride1) {
      ...
      for(size_t i0 = tid0+NGHOSTS; i0 < Nxx0+NGHOSTS; i0 += stride0) {
        ...
        const REAL hDD_dDD0000 = fd_function_dDD00_fdorder8(hDD00, hDD00_i0m1, hDD00_i0m2, hDD00_i0m3, hDD00_i0m4, hDD00_i0p1, hDD00_i0p2, hDD00_i0p3,
                                                            hDD00_i0p4, invdxx0);
        const REAL hDD_dDD0001 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD0002 = fd_function_dDD02_fdorder8(
        ...
        const REAL hDD_dDD0011 = fd_function_dDD11_fdorder8(hDD00, hDD00_i1m1, hDD00_i1m2, hDD00_i1m3, hDD00_i1m4, hDD00_i1p1, hDD00_i1p2, hDD00_i1p3,
                                                            hDD00_i1p4, invdxx1);
        const REAL hDD_dDD0012 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD0022 = fd_function_dDD22_fdorder8(hDD00, hDD00_i2m1, hDD00_i2m2, hDD00_i2m3, hDD00_i2m4, hDD00_i2p1, hDD00_i2p2, hDD00_i2p3,
                                                            hDD00_i2p4, invdxx2);
        const REAL hDD_dDD0100 = fd_function_dDD00_fdorder8(hDD01, hDD01_i0m1, hDD01_i0m2, hDD01_i0m3, hDD01_i0m4, hDD01_i0p1, hDD01_i0p2, hDD01_i0p3,
                                                            hDD01_i0p4, invdxx0);
        const REAL hDD_dDD0101 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD0102 = fd_function_dDD02_fdorder8(
            ...
            invdxx0, invdxx2);
        const REAL hDD_dDD0111 = fd_function_dDD11_fdorder8(hDD01, hDD01_i1m1, hDD01_i1m2, hDD01_i1m3, hDD01_i1m4, hDD01_i1p1, hDD01_i1p2, hDD01_i1p3,
                                                            hDD01_i1p4, invdxx1);
        const REAL hDD_dDD0112 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD0122 = fd_function_dDD22_fdorder8(hDD01, hDD01_i2m1, hDD01_i2m2, hDD01_i2m3, hDD01_i2m4, hDD01_i2p1, hDD01_i2p2, hDD01_i2p3,
                                                            hDD01_i2p4, invdxx2);
        const REAL hDD_dDD0200 = fd_function_dDD00_fdorder8(hDD02, hDD02_i0m1, hDD02_i0m2, hDD02_i0m3, hDD02_i0m4, hDD02_i0p1, hDD02_i0p2, hDD02_i0p3,
                                                            hDD02_i0p4, invdxx0);
        const REAL hDD_dDD0201 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD0202 = fd_function_dDD02_fdorder8(
        ...
        const REAL hDD_dDD0211 = fd_function_dDD11_fdorder8(hDD02, hDD02_i1m1, hDD02_i1m2, hDD02_i1m3, hDD02_i1m4, hDD02_i1p1, hDD02_i1p2, hDD02_i1p3,
                                                            hDD02_i1p4, invdxx1);
        const REAL hDD_dDD0212 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD0222 = fd_function_dDD22_fdorder8(hDD02, hDD02_i2m1, hDD02_i2m2, hDD02_i2m3, hDD02_i2m4, hDD02_i2p1, hDD02_i2p2, hDD02_i2p3,
                                                            hDD02_i2p4, invdxx2);
        const REAL hDD_dDD1100 = fd_function_dDD00_fdorder8(hDD11, hDD11_i0m1, hDD11_i0m2, hDD11_i0m3, hDD11_i0m4, hDD11_i0p1, hDD11_i0p2, hDD11_i0p3,
                                                            hDD11_i0p4, invdxx0);
        const REAL hDD_dDD1101 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD1102 = fd_function_dDD02_fdorder8(
            ...
            invdxx0, invdxx2);
        const REAL hDD_dDD1111 = fd_function_dDD11_fdorder8(hDD11, hDD11_i1m1, hDD11_i1m2, hDD11_i1m3, hDD11_i1m4, hDD11_i1p1, hDD11_i1p2, hDD11_i1p3,
                                                            hDD11_i1p4, invdxx1);
        const REAL hDD_dDD1112 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD1122 = fd_function_dDD22_fdorder8(hDD11, hDD11_i2m1, hDD11_i2m2, hDD11_i2m3, hDD11_i2m4, hDD11_i2p1, hDD11_i2p2, hDD11_i2p3,
                                                            hDD11_i2p4, invdxx2);
        ...
        const REAL hDD_dDD1201 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD1202 = fd_function_dDD02_fdorder8(
            ...
            invdxx0, invdxx2);
        const REAL hDD_dDD1211 = fd_function_dDD11_fdorder8(hDD12, hDD12_i1m1, hDD12_i1m2, hDD12_i1m3, hDD12_i1m4, hDD12_i1p1, hDD12_i1p2, hDD12_i1p3,
                                                            hDD12_i1p4, invdxx1);
        const REAL hDD_dDD1212 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD1222 = fd_function_dDD22_fdorder8(hDD12, hDD12_i2m1, hDD12_i2m2, hDD12_i2m3, hDD12_i2m4, hDD12_i2p1, hDD12_i2p2, hDD12_i2p3,
                                                            hDD12_i2p4, invdxx2);
        ...
        const REAL hDD_dDD2201 = fd_function_dDD01_fdorder8(
            ...
            invdxx0, invdxx1);
        const REAL hDD_dDD2202 = fd_function_dDD02_fdorder8(
        ...
        const REAL hDD_dDD2211 = fd_function_dDD11_fdorder8(hDD22, hDD22_i1m1, hDD22_i1m2, hDD22_i1m3, hDD22_i1m4, hDD22_i1p1, hDD22_i1p2, hDD22_i1p3,
                                                            hDD22_i1p4, invdxx1);
        const REAL hDD_dDD2212 = fd_function_dDD12_fdorder8(
            ...
            invdxx1, invdxx2);
        const REAL hDD_dDD2222 = fd_function_dDD22_fdorder8(hDD22, hDD22_i2m1, hDD22_i2m2, hDD22_i2m3, hDD22_i2m4, hDD22_i2p1, hDD22_i2p2, hDD22_i2p3,
                                                            hDD22_i2p4, invdxx2);
        const REAL lambdaU_dD00 = fd_function_dD0_fdorder8(lambdaU0_i0m1, lambdaU0_i0m2, lambdaU0_i0m3, lambdaU0_i0m4, lambdaU0_i0p1, lambdaU0_i0p2,
                                                           lambdaU0_i0p3, lambdaU0_i0p4, invdxx0);
        const REAL lambdaU_dD01 = fd_function_dD1_fdorder8(lambdaU0_i1m1, lambdaU0_i1m2, lambdaU0_i1m3, lambdaU0_i1m4, lambdaU0_i1p1, lambdaU0_i1p2,
                                                           lambdaU0_i1p3, lambdaU0_i1p4, invdxx1);
        const REAL lambdaU_dD02 = fd_function_dD2_fdorder8(lambdaU0_i2m1, lambdaU0_i2m2, lambdaU0_i2m3, lambdaU0_i2m4, lambdaU0_i2p1, lambdaU0_i2p2,
                                                           lambdaU0_i2p3, lambdaU0_i2p4, invdxx2);
        const REAL lambdaU_dD10 = fd_function_dD0_fdorder8(lambdaU1_i0m1, lambdaU1_i0m2, lambdaU1_i0m3, lambdaU1_i0m4, lambdaU1_i0p1, lambdaU1_i0p2,
                                                           lambdaU1_i0p3, lambdaU1_i0p4, invdxx0);
        const REAL lambdaU_dD11 = fd_function_dD1_fdorder8(lambdaU1_i1m1, lambdaU1_i1m2, lambdaU1_i1m3, lambdaU1_i1m4, lambdaU1_i1p1, lambdaU1_i1p2,
                                                           lambdaU1_i1p3, lambdaU1_i1p4, invdxx1);
        const REAL lambdaU_dD12 = fd_function_dD2_fdorder8(lambdaU1_i2m1, lambdaU1_i2m2, lambdaU1_i2m3, lambdaU1_i2m4, lambdaU1_i2p1, lambdaU1_i2p2,
                                                           lambdaU1_i2p3, lambdaU1_i2p4, invdxx2);
        const REAL lambdaU_dD20 = fd_function_dD0_fdorder8(lambdaU2_i0m1, lambdaU2_i0m2, lambdaU2_i0m3, lambdaU2_i0m4, lambdaU2_i0p1, lambdaU2_i0p2,
                                                           lambdaU2_i0p3, lambdaU2_i0p4, invdxx0);
        const REAL lambdaU_dD21 = fd_function_dD1_fdorder8(lambdaU2_i1m1, lambdaU2_i1m2, lambdaU2_i1m3, lambdaU2_i1m4, lambdaU2_i1p1, lambdaU2_i1p2,
                                                           lambdaU2_i1p3, lambdaU2_i1p4, invdxx1);
        const REAL lambdaU_dD22 = fd_function_dD2_fdorder8(lambdaU2_i2m1, lambdaU2_i2m2, lambdaU2_i2m3, lambdaU2_i2m4, lambdaU2_i2p1, lambdaU2_i2p2,
                                                           lambdaU2_i2p3, lambdaU2_i2p4, invdxx2);
