  ...
  for(size_t i2 = tid2+NGHOSTS; i2 < Nxx2+NGHOSTS; i2 += stride2) {
    for(size_t i1 = tid1+NGHOSTS; i1 < Nxx1+NGHOSTS; i1 += stride1) {
      for(size_t i0 = tid0+NGHOSTS; i0 < Nxx0+NGHOSTS; i0 += stride0) {
        ...
        const REAL hDD_dD002 = invdxx2 * (FDPart1_Rational_1_280 * (hDD00_i2m4 - hDD00_i2p4) + FDPart1_Rational_1_5 * (hDD00_i2m2 - hDD00_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD00_i2m3 + hDD00_i2p3) + FDPart1_Rational_4_5 * (-hDD00_i2m1 + hDD00_i2p1));
        ...
        const REAL hDD_dD012 = invdxx2 * (FDPart1_Rational_1_280 * (hDD01_i2m4 - hDD01_i2p4) + FDPart1_Rational_1_5 * (hDD01_i2m2 - hDD01_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD01_i2m3 + hDD01_i2p3) + FDPart1_Rational_4_5 * (-hDD01_i2m1 + hDD01_i2p1));
        ...
        const REAL hDD_dD022 = invdxx2 * (FDPart1_Rational_1_280 * (hDD02_i2m4 - hDD02_i2p4) + FDPart1_Rational_1_5 * (hDD02_i2m2 - hDD02_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD02_i2m3 + hDD02_i2p3) + FDPart1_Rational_4_5 * (-hDD02_i2m1 + hDD02_i2p1));
        ...
        const REAL hDD_dD112 = invdxx2 * (FDPart1_Rational_1_280 * (hDD11_i2m4 - hDD11_i2p4) + FDPart1_Rational_1_5 * (hDD11_i2m2 - hDD11_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD11_i2m3 + hDD11_i2p3) + FDPart1_Rational_4_5 * (-hDD11_i2m1 + hDD11_i2p1));
        ...
        const REAL hDD_dD122 = invdxx2 * (FDPart1_Rational_1_280 * (hDD12_i2m4 - hDD12_i2p4) + FDPart1_Rational_1_5 * (hDD12_i2m2 - hDD12_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD12_i2m3 + hDD12_i2p3) + FDPart1_Rational_4_5 * (-hDD12_i2m1 + hDD12_i2p1));
        ...
        const REAL hDD_dD222 = invdxx2 * (FDPart1_Rational_1_280 * (hDD22_i2m4 - hDD22_i2p4) + FDPart1_Rational_1_5 * (hDD22_i2m2 - hDD22_i2p2) +
                                          FDPart1_Rational_4_105 * (-hDD22_i2m3 + hDD22_i2p3) + FDPart1_Rational_4_5 * (-hDD22_i2m1 + hDD22_i2p1));
