 ...
 */
__device__ void auxevol_gfs_single_point(const REAL xx0, const REAL xx1, const REAL xx2, REAL *restrict psi_background,
                                         REAL *restrict ADD_times_AUU) {
  // Temporary variables to needed parameters and commondata.
