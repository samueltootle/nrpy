...
#include "../set_CodeParameters.h"
  ...
  const REAL *restrict k_odd_gfs = gridfuncs->k_odd_gfs;

  // 1D output
  char filename[256];
  sprintf(filename, "out1d-y-conv_factor%.2f-t%08.4f.txt", convergence_factor, time);
...
#pragma omp parallel for
  ...
  LOOP_NOOMP(i0_pt, 0, numpts_i0, i1_pt, 0, numpts_i1, i2_pt, 0, numpts_i2) {
    ...
    //   data_point_1d_struct dp1d;
    //   dp1d.xCart_axis = xCart[1];
    //   const REAL GF1 = y_n_gfs[IDX4pt(idx, idx3)];
    //   dp1d.log10HL = GF1;
    //   const REAL GF2 = y_n_gfs[IDX4pt(idx+1, idx3)];
    //   dp1d.log10sqrtM2L = GF2;
    //   dp1d.cfL = y_n_gfs[IDX4pt(idx+2, idx3)];
    //   dp1d.alphaL = y_n_gfs[IDX4pt(idx+3, idx3)];
    //   dp1d.trKL = y_n_gfs[IDX4pt(idx+4, idx3)];
    //   data_points[data_index] = dp1d;
    //   data_index++;
    // }
    // {
    ...
    //   data_point_1d_struct dp1d;
    //   dp1d.xCart_axis = xCart[1];
    //   const REAL GF1 = auxevol_gfs[IDX4pt(idx, idx3)];
    //   dp1d.log10HL = GF1;
    //   const REAL GF2 = auxevol_gfs[IDX4pt(idx+1, idx3)];
    //   dp1d.log10sqrtM2L = GF2;
    //   dp1d.cfL = auxevol_gfs[IDX4pt(idx+2, idx3)];
    //   dp1d.alphaL = auxevol_gfs[IDX4pt(idx+3, idx3)];
    //   dp1d.trKL = auxevol_gfs[IDX4pt(idx+4, idx3)];
    //   data_points[data_index] = dp1d;
    //   data_index++;
    // }
