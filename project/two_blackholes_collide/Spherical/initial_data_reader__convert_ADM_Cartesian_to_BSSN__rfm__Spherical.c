...
void print_gfs(const params_struct *restrict params, MoL_gridfunctions_struct *restrict gridfuncs, size_t idx3) {
            const int Nxx_plus_2NGHOSTS0 = params->Nxx_plus_2NGHOSTS0;
  const int Nxx_plus_2NGHOSTS1 = params->Nxx_plus_2NGHOSTS1;
  const int Nxx_plus_2NGHOSTS2 = params->Nxx_plus_2NGHOSTS2;
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD00GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD01GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD02GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD11GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD12GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ADD22GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(ALPHAGF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(BETU0GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(BETU1GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(BETU2GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(CFGF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD00GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD01GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD02GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD11GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD12GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(HDD22GF, idx3));          
          print_var(gridfuncs->y_n_gfs,IDX4pt(TRKGF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(VETU0GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(VETU1GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(VETU2GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(LAMBDAU0GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(LAMBDAU1GF, idx3));
          print_var(gridfuncs->y_n_gfs,IDX4pt(LAMBDAU2GF, idx3));
}
...
void initial_data_reader__convert_ADM_Cartesian_to_BSSN__rfm__Spherical(
  ...
  // printf("arb: \n");
  // print_gfs(params, gridfuncs, arbidx);
  // abort();
}
