...
static void print_usage() {
  fprintf(stderr, "Usage option 0: ./two_blackholes_collide [--help or -h] <- Outputs this usage command\n");
  fprintf(stderr, "Usage option 1: ./two_blackholes_collide <- reads in parameter file two_blackholes_collide.par\n");
  fprintf(stderr, "Usage option 2: ./two_blackholes_collide [parfile] <- reads in parameter file [parfile]\n");
  fprintf(
      stderr,
      "Usage option 3: ./two_blackholes_collide [convergence_factor] <- overwrites parameters in list after reading in two_blackholes_collide.par\n");
  fprintf(stderr, "Usage option 4: ./two_blackholes_collide [parfile] [convergence_factor] <- overwrites list of steerable parameters after reading "
                  "in [parfile]\n");
}
...
void cmdline_input_and_parfile_parser(commondata_struct *restrict commondata, int argc, const char *argv[]) {
  ...
  if (argc == 1) {
    option = 1; // Usage option 1: Process default parameter file "two_blackholes_collide.par"
  } else if (argc == 2) {
    ...
    option = 3; // Usage option 3: Overwrite steerable parameters after processing "two_blackholes_collide.par"
  ...
  const char *filename = (option == 1 || option == 3) ? "two_blackholes_collide.par" : argv[1];
