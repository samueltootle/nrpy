...
// #include "set_CodeParameters.h"
  ...
  const REAL tmp3 =
      (1.0F / 2.0F) * BH1_mass /
          sqrtf(((-BH1_posn_x + x) * (-BH1_posn_x + x)) + ((-BH1_posn_y - tmp1) * (-BH1_posn_y - tmp1)) + ((-BH1_posn_z + z) * (-BH1_posn_z + z))) +
      (1.0F / 2.0F) * BH2_mass /
          sqrtf(((-BH2_posn_x + x) * (-BH2_posn_x + x)) + ((-BH2_posn_y - tmp1) * (-BH2_posn_y - tmp1)) + ((-BH2_posn_z + z) * (-BH2_posn_z + z))) +
      1;
  ...
  initial_data->alpha = powf(powf(tmp3, 12), -1.0F / 6.0F);
