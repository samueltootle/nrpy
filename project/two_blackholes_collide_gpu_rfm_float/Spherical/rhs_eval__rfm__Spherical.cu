  ...
  for(int i2 = tid2+NGHOSTS; i2 < Nxx2+NGHOSTS; i2 += stride2) {
    for(int i1 = tid1+NGHOSTS; i1 < Nxx1+NGHOSTS; i1 += stride1) {
      ...
      for(int i0 = tid0+NGHOSTS; i0 < Nxx0+NGHOSTS; i0 += stride0) {
        ...
        const REAL FDPart3tmp291 = (3.0F / 4.0F) * lambdaU0;
        const REAL FDPart3tmp317 = 3 * alpha;
        const REAL FDPart3tmp351 = (3.0F / 2.0F) * alpha;
        ...
        const REAL FDPart3tmp83 = (1.0F / 2.0F) * FDPart3tmp71;
        ...
        const REAL FDPart3tmp223 = (2.0F / 3.0F) * FDPart3tmp7;
        ...
        const REAL FDPart3tmp130 = (1.0F / 2.0F) * FDPart3tmp7 * hDD_dD111;
        ...
        const REAL FDPart3tmp272 = (1.0F / 2.0F) * FDPart3tmp203 / FDPart3tmp29;
        ...
        const REAL FDPart3tmp298 = (3.0F / 4.0F) * FDPart3tmp274 * lambdaU1;
        const REAL FDPart3tmp302 = FDPart3tmp5 * betU2;
        const REAL FDPart3tmp306 = (3.0F / 4.0F) * FDPart3tmp5 * lambdaU2 * vetU0;
        ...
        const REAL FDPart3tmp186 = (1.0F / 2.0F) * FDPart3tmp35 * hDD_dD222;
        ...
        const REAL FDPart3tmp300 = (3.0F / 4.0F) * FDPart3tmp9 * lambdaU1;
        ...
        const REAL FDPart3tmp312 = (3.0F / 4.0F) * FDPart3tmp14 * FDPart3tmp8 * lambdaU1;
        ...
        const REAL FDPart3tmp417 = (3.0F / 4.0F) * FDPart3tmp242 * FDPart3tmp9;
        ...
        const REAL FDPart3tmp27 = (2.0F / 3.0F) * FDPart3tmp26;
        ...
        const REAL FDPart3tmp74 = (1.0F / 2.0F) * FDPart3tmp41 * hDD_dD000;
        ...
        const REAL FDPart3tmp283 = (1.0F / 4.0F) * FDPart3tmp282;
        const REAL FDPart3tmp289 = (1.0F / 4.0F) * FDPart3tmp288;
        ...
        const REAL FDPart3tmp453 = (1.0F / 3.0F) * FDPart3tmp282;
        const REAL FDPart3tmp454 = (1.0F / 3.0F) * FDPart3tmp288;
        const REAL FDPart3tmp81 =
            (1.0F / 2.0F) * FDPart3tmp46 * FDPart3tmp76 + FDPart3tmp50 * FDPart3tmp74 + (1.0F / 2.0F) * FDPart3tmp53 * FDPart3tmp79;
        const REAL FDPart3tmp85 =
            (1.0F / 2.0F) * FDPart3tmp46 * FDPart3tmp79 + FDPart3tmp57 * FDPart3tmp74 + (1.0F / 2.0F) * FDPart3tmp59 * FDPart3tmp76;
        const REAL FDPart3tmp89 = (1.0F / 2.0F) * FDPart3tmp41 * FDPart3tmp50;
        const REAL FDPart3tmp90 = (1.0F / 2.0F) * FDPart3tmp41 * FDPart3tmp57;
        const REAL FDPart3tmp117 = (1.0F / 2.0F) * FDPart3tmp66;
        ...
        const REAL FDPart3tmp262 = (3.0F / 2.0F) * FDPart3tmp63;
        const REAL FDPart3tmp265 = (3.0F / 2.0F) * FDPart3tmp61;
        ...
        const REAL FDPart3tmp394 = (2.0F / 3.0F) * FDPart3tmp66;
        const REAL FDPart3tmp395 = (4.0F / 3.0F) * FDPart3tmp63;
        const REAL FDPart3tmp396 = (4.0F / 3.0F) * FDPart3tmp46;
        const REAL FDPart3tmp397 = (4.0F / 3.0F) * FDPart3tmp61;
        const REAL FDPart3tmp398 = (2.0F / 3.0F) * FDPart3tmp59;
        const REAL FDPart3tmp399 = (2.0F / 3.0F) * FDPart3tmp53;
        ...
        const REAL FDPart3tmp91 = (1.0F / 2.0F) * FDPart3tmp66 * hDD_dD000 + FDPart3tmp76 * FDPart3tmp90 + FDPart3tmp79 * FDPart3tmp89;
        const REAL FDPart3tmp113 =
            (1.0F / 2.0F) * FDPart3tmp100 * FDPart3tmp46 + (1.0F / 2.0F) * FDPart3tmp111 * FDPart3tmp53 + FDPart3tmp89 * hDD_dD001;
        const REAL FDPart3tmp115 =
            (1.0F / 2.0F) * FDPart3tmp100 * FDPart3tmp59 + (1.0F / 2.0F) * FDPart3tmp111 * FDPart3tmp46 + FDPart3tmp90 * hDD_dD001;
        const REAL FDPart3tmp118 = FDPart3tmp100 * FDPart3tmp90 + FDPart3tmp111 * FDPart3tmp89 + FDPart3tmp117 * hDD_dD001;
        const REAL FDPart3tmp138 = FDPart3tmp130 * FDPart3tmp46 + FDPart3tmp131 * FDPart3tmp89 + (1.0F / 2.0F) * FDPart3tmp136 * FDPart3tmp53;
        const REAL FDPart3tmp140 = FDPart3tmp130 * FDPart3tmp59 + FDPart3tmp131 * FDPart3tmp90 + (1.0F / 2.0F) * FDPart3tmp136 * FDPart3tmp46;
        ...
        const REAL FDPart3tmp153 =
            (1.0F / 2.0F) * FDPart3tmp147 * FDPart3tmp46 + (1.0F / 2.0F) * FDPart3tmp151 * FDPart3tmp53 + FDPart3tmp89 * hDD_dD002;
        const REAL FDPart3tmp155 =
            (1.0F / 2.0F) * FDPart3tmp147 * FDPart3tmp59 + (1.0F / 2.0F) * FDPart3tmp151 * FDPart3tmp46 + FDPart3tmp90 * hDD_dD002;
        ...
        const REAL FDPart3tmp173 =
            (1.0F / 2.0F) * FDPart3tmp132 * FDPart3tmp46 + (1.0F / 2.0F) * FDPart3tmp170 * FDPart3tmp53 + FDPart3tmp172 * FDPart3tmp89;
        const REAL FDPart3tmp175 =
            (1.0F / 2.0F) * FDPart3tmp132 * FDPart3tmp59 + (1.0F / 2.0F) * FDPart3tmp170 * FDPart3tmp46 + FDPart3tmp172 * FDPart3tmp90;
        const REAL FDPart3tmp177 = FDPart3tmp117 * FDPart3tmp172 + FDPart3tmp132 * FDPart3tmp90 + FDPart3tmp170 * FDPart3tmp89;
        const REAL FDPart3tmp190 = FDPart3tmp186 * FDPart3tmp53 + (1.0F / 2.0F) * FDPart3tmp187 * FDPart3tmp46 + FDPart3tmp189 * FDPart3tmp89;
        const REAL FDPart3tmp192 = FDPart3tmp186 * FDPart3tmp46 + (1.0F / 2.0F) * FDPart3tmp187 * FDPart3tmp59 + FDPart3tmp189 * FDPart3tmp90;
        ...
        const REAL FDPart3tmp366 = (3.0F / 2.0F) * FDPart3tmp364 * alpha;
        ...
        const REAL FDPart3tmp98 = FDPart3tmp68 * ((1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * ((cf_dD0) * (cf_dD0)) - cf_dDD00) +
        ...
        const REAL FDPart3tmp125 = FDPart3tmp120 * alpha_dD0 + FDPart3tmp123 + FDPart3tmp124 +
                                   FDPart3tmp68 * (FDPart3tmp113 * FDPart3tmp84 + FDPart3tmp115 * FDPart3tmp87 + FDPart3tmp118 * FDPart3tmp93 +
                                                   (1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * cf_dD0 * cf_dD1 - cf_dDD01)) -
        ...
        const REAL FDPart3tmp146 = 2 * FDPart3tmp120 * alpha_dD1 + FDPart3tmp145 +
                                   FDPart3tmp68 * (FDPart3tmp138 * FDPart3tmp84 + FDPart3tmp140 * FDPart3tmp87 + FDPart3tmp142 * FDPart3tmp93 +
                                                   (1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * ((cf_dD1) * (cf_dD1)) - cf_dDD11)) -
        ...
        const REAL FDPart3tmp163 = FDPart3tmp159 * alpha_dD0 + FDPart3tmp162 +
                                   FDPart3tmp68 * (FDPart3tmp153 * FDPart3tmp84 + FDPart3tmp155 * FDPart3tmp87 + FDPart3tmp157 * FDPart3tmp93 +
                                                   (1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * cf_dD0 * cf_dD2 - cf_dDD02)) -
        ...
        const REAL FDPart3tmp182 = FDPart3tmp120 * alpha_dD2 + FDPart3tmp179 + FDPart3tmp181 +
                                   FDPart3tmp68 * (FDPart3tmp173 * FDPart3tmp84 + FDPart3tmp175 * FDPart3tmp87 + FDPart3tmp177 * FDPart3tmp93 +
                                                   (1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * cf_dD1 * cf_dD2 - cf_dDD12)) -
        ...
        const REAL FDPart3tmp198 = 2 * FDPart3tmp159 * alpha_dD2 + FDPart3tmp197 +
                                   FDPart3tmp68 * (FDPart3tmp190 * FDPart3tmp84 + FDPart3tmp192 * FDPart3tmp87 + FDPart3tmp194 * FDPart3tmp93 +
                                                   (1.0F / 2.0F) * FDPart3tmp71 * (FDPart3tmp71 * ((cf_dD2) * (cf_dD2)) - cf_dDD22)) -
        ...
        rhs_gfs[IDX4(ADD00GF, i0, i1, i2)] =
            ...
            FDPart3tmp70 * (-FDPart3tmp199 * ((1.0F / 3.0F) * hDD00 + 1.0F / 3.0F) - FDPart3tmp98) + 2 * aDD00 * vetU_dD00 + aDD_dupD000 * vetU0;
        rhs_gfs[IDX4(ADD01GF, i0, i1, i2)] =
            FDPart3tmp2 * (FDPart3tmp1 * FDPart3tmp28 + FDPart3tmp11 * FDPart3tmp201 + FDPart3tmp14 * aDD_dupD012 + FDPart3tmp17 * FDPart3tmp207 +
                           FDPart3tmp200 * aDD01 + FDPart3tmp206 * FDPart3tmp54 - FDPart3tmp208 * FDPart3tmp55 - FDPart3tmp211 * FDPart3tmp60 -
                           FDPart3tmp212 * FDPart3tmp69 - FDPart3tmp27 * FDPart3tmp28 +
                           FDPart3tmp70 * (-FDPart3tmp125 - 1.0F / 3.0F * FDPart3tmp199 * FDPart3tmp56) + aDD00 * vetU_dD01 + aDD01 * vetU_dD11 +
                           aDD_dupD011 * vetU1 + vetU0 * (aDD01 + aDD_dupD010 * f0_of_xx0));
        rhs_gfs[IDX4(ADD02GF, i0, i1, i2)] =
            FDPart3tmp5 * (FDPart3tmp1 * FDPart3tmp54 + FDPart3tmp11 * FDPart3tmp207 + FDPart3tmp17 * FDPart3tmp214 + FDPart3tmp18 * FDPart3tmp200 -
                           ...
                           FDPart3tmp70 * (-FDPart3tmp163 - 1.0F / 3.0F * FDPart3tmp199 * FDPart3tmp49) + aDD00 * vetU_dD02 + aDD01 * vetU_dD12 +
        ...
        rhs_gfs[IDX4(ADD11GF, i0, i1, i2)] =
            FDPart3tmp8 * (FDPart3tmp1 * FDPart3tmp201 + FDPart3tmp12 * aDD11 * vetU_dD11 + FDPart3tmp13 * vetU_dD01 +
                           ...
                           FDPart3tmp70 * (-FDPart3tmp146 - FDPart3tmp199 * ((1.0F / 3.0F) * FDPart3tmp33 + (1.0F / 3.0F) * FDPart3tmp7)) +
        ...
        rhs_gfs[IDX4(ADD12GF, i0, i1, i2)] =
            ...
            (FDPart3tmp1 * FDPart3tmp207 + FDPart3tmp105 * aDD12 * vetU_dD11 + FDPart3tmp206 * FDPart3tmp214 - FDPart3tmp216 * FDPart3tmp225 -
             ...
             FDPart3tmp70 * (-FDPart3tmp182 - 1.0F / 3.0F * FDPart3tmp199 * FDPart3tmp7 * f1_of_xx1 * hDD12) + aDD11 * f0_of_xx0 * vetU_dD12 +
        ...
        rhs_gfs[IDX4(ADD22GF, i0, i1, i2)] =
            ...
            (FDPart3tmp1 * FDPart3tmp214 + FDPart3tmp105 * aDD_dupD222 * vetU2 + FDPart3tmp12 * aDD22 * f1_of_xx1 * vetU_dD22 +
             ...
             FDPart3tmp70 * (-FDPart3tmp198 - FDPart3tmp199 * ((1.0F / 3.0F) * FDPart3tmp35 + (1.0F / 3.0F) * FDPart3tmp37)) +
        ...
        rhs_gfs[IDX4(BETU0GF, i0, i1, i2)] =
            ...
            FDPart3tmp194 * FDPart3tmp316 - 3.0F / 4.0F * FDPart3tmp239 * lambdaU1 - 3.0F / 4.0F * FDPart3tmp241 * FDPart3tmp242 -
            3.0F / 4.0F * FDPart3tmp242 * FDPart3tmp309 - FDPart3tmp244 * FDPart3tmp61 - FDPart3tmp245 * FDPart3tmp63 - FDPart3tmp247 * FDPart3tmp66 +
            (3.0F / 4.0F) * FDPart3tmp250 + (3.0F / 4.0F) * FDPart3tmp253 + FDPart3tmp259 * FDPart3tmp61 + FDPart3tmp261 * FDPart3tmp262 +
            FDPart3tmp264 * FDPart3tmp265 + (3.0F / 2.0F) * FDPart3tmp266 * FDPart3tmp46 + FDPart3tmp283 * FDPart3tmp63 +
            FDPart3tmp289 * FDPart3tmp66 + FDPart3tmp290 * FDPart3tmp91 - FDPart3tmp292 * FDPart3tmp91 + FDPart3tmp3 * betU_dupD01 +
            FDPart3tmp309 * FDPart3tmp4 * betU2 + (3.0F / 4.0F) * FDPart3tmp337 + FDPart3tmp338 * FDPart3tmp352 + FDPart3tmp351 * FDPart3tmp361 +
            FDPart3tmp366 * FDPart3tmp91 + (3.0F / 4.0F) * FDPart3tmp367 * FDPart3tmp375 + (3.0F / 4.0F) * FDPart3tmp377 * FDPart3tmp382 +
            (3.0F / 4.0F) * FDPart3tmp400 + FDPart3tmp6 * betU_dupD02 + (3.0F / 4.0F) * FDPart3tmp66 * vetU_dDD000 - betU0 * eta +
            betU_dupD00 * vetU0 - 3.0F / 4.0F * lambdaU0 * vetU_dD00;
        rhs_gfs[IDX4(BETU1GF, i0, i1, i2)] =
            f0_of_xx0 *
            (-3.0F / 4.0F * FDPart3tmp11 * lambdaU0 + FDPart3tmp115 * FDPart3tmp293 + FDPart3tmp115 * FDPart3tmp295 - FDPart3tmp115 * FDPart3tmp296 -
             ...
             (3.0F / 4.0F) * FDPart3tmp318 * FDPart3tmp382 + FDPart3tmp352 * FDPart3tmp419 + FDPart3tmp366 * FDPart3tmp85 +
             (3.0F / 4.0F) * FDPart3tmp367 * FDPart3tmp421 + FDPart3tmp393 * FDPart3tmp425 - 3.0F / 4.0F * FDPart3tmp401 -
             3.0F / 4.0F * FDPart3tmp403 + (3.0F / 4.0F) * FDPart3tmp409 + (3.0F / 4.0F) * FDPart3tmp411 + (3.0F / 4.0F) * FDPart3tmp413 +
             (3.0F / 4.0F) * FDPart3tmp414 + (3.0F / 4.0F) * FDPart3tmp415 + (3.0F / 4.0F) * FDPart3tmp418 + (3.0F / 4.0F) * FDPart3tmp426 +
             FDPart3tmp9 * betU_dupD11 + vetU0 * (FDPart3tmp2 * betU_dupD10 - FDPart3tmp8 * betU1));
        rhs_gfs[IDX4(BETU2GF, i0, i1, i2)] =
            ...
            (FDPart3tmp113 * FDPart3tmp293 + FDPart3tmp113 * FDPart3tmp295 - FDPart3tmp113 * FDPart3tmp296 - FDPart3tmp113 * FDPart3tmp298 +
             ...
             FDPart3tmp153 * FDPart3tmp304 - FDPart3tmp153 * FDPart3tmp306 - 3.0F / 4.0F * FDPart3tmp17 * lambdaU0 + FDPart3tmp173 * FDPart3tmp308 -
             ...
             (3.0F / 4.0F) * FDPart3tmp318 * FDPart3tmp375 + FDPart3tmp366 * FDPart3tmp81 + (3.0F / 4.0F) * FDPart3tmp377 * FDPart3tmp421 +
             FDPart3tmp389 * FDPart3tmp446 + FDPart3tmp391 * FDPart3tmp447 - 3.0F / 4.0F * FDPart3tmp427 - 3.0F / 4.0F * FDPart3tmp430 +
             (3.0F / 4.0F) * FDPart3tmp433 + (3.0F / 4.0F) * FDPart3tmp435 + (3.0F / 4.0F) * FDPart3tmp437 + (3.0F / 4.0F) * FDPart3tmp439 +
             (3.0F / 4.0F) * FDPart3tmp442 + (3.0F / 4.0F) * FDPart3tmp443 + (3.0F / 4.0F) * FDPart3tmp448 +
             vetU0 * (FDPart3tmp2 * FDPart3tmp4 * betU_dupD20 - FDPart3tmp233 * betU2));
        rhs_gfs[IDX4(CFGF, i0, i1, i2)] =
            -2 * cf *
            (-1.0F / 6.0F * FDPart3tmp1 + (1.0F / 6.0F) * FDPart3tmp20 + (1.0F / 6.0F) * FDPart3tmp24 * FDPart3tmp3 + (1.0F / 3.0F) * FDPart3tmp274 -
             FDPart3tmp3 * FDPart3tmp83 * cf_dupD1 + (1.0F / 6.0F) * FDPart3tmp5 * vetU_dD22 - FDPart3tmp6 * FDPart3tmp83 * cf_dupD2 -
             FDPart3tmp83 * cf_dupD0 * vetU0 + (1.0F / 6.0F) * vetU_dD00);
        rhs_gfs[IDX4(HDD00GF, i0, i1, i2)] = FDPart3tmp12 * FDPart3tmp17 * FDPart3tmp42 + FDPart3tmp260 * FDPart3tmp75 + FDPart3tmp3 * hDD_dupD001 +
                                             2 * FDPart3tmp31 * vetU_dD00 + FDPart3tmp450 * ((2.0F / 3.0F) * hDD00 + 2.0F / 3.0F) +
        ...
        rhs_gfs[IDX4(HDD01GF, i0, i1, i2)] =
            FDPart3tmp2 * (FDPart3tmp11 * FDPart3tmp34 + FDPart3tmp14 * hDD_dupD012 + FDPart3tmp17 * FDPart3tmp44 + FDPart3tmp200 * hDD01 +
                           FDPart3tmp206 * FDPart3tmp49 + FDPart3tmp31 * vetU_dD01 + (2.0F / 3.0F) * FDPart3tmp450 * FDPart3tmp56 - FDPart3tmp60 +
        ...
        rhs_gfs[IDX4(HDD02GF, i0, i1, i2)] =
            ...
            (FDPart3tmp11 * FDPart3tmp44 + FDPart3tmp17 * FDPart3tmp38 + FDPart3tmp200 * FDPart3tmp42 +
             FDPart3tmp3 * (FDPart3tmp104 + FDPart3tmp105 * hDD_dupD021) + FDPart3tmp31 * vetU_dD02 + (2.0F / 3.0F) * FDPart3tmp450 * FDPart3tmp49 -
        ...
        rhs_gfs[IDX4(HDD11GF, i0, i1, i2)] =
            FDPart3tmp8 * (FDPart3tmp14 * f0_of_xx0 * hDD_dupD112 + 2 * FDPart3tmp20 * FDPart3tmp34 + 2 * FDPart3tmp206 * FDPart3tmp44 -
                           FDPart3tmp226 + FDPart3tmp450 * (FDPart3tmp223 + (2.0F / 3.0F) * FDPart3tmp33) + FDPart3tmp75 * f0_of_xx0 * vetU_dD01 +
        ...
        rhs_gfs[IDX4(HDD22GF, i0, i1, i2)] =
            ...
            (FDPart3tmp105 * hDD_dupD222 * vetU2 + FDPart3tmp108 * vetU_dD12 + FDPart3tmp12 * FDPart3tmp42 * vetU_dD02 +
             ...
             FDPart3tmp3 * (FDPart3tmp169 + FDPart3tmp35 * hDD_dupD221) +
             FDPart3tmp450 * ((2.0F / 3.0F) * FDPart3tmp35 + (2.0F / 3.0F) * FDPart3tmp37) + vetU0 * (FDPart3tmp150 + FDPart3tmp35 * hDD_dupD220));
        rhs_gfs[IDX4(LAMBDAU0GF, i0, i1, i2)] =
            ...
            FDPart3tmp245 * FDPart3tmp395 - 4.0F / 3.0F * FDPart3tmp247 * FDPart3tmp66 + FDPart3tmp250 + FDPart3tmp253 +
        ...
        rhs_gfs[IDX4(LAMBDAU1GF, i0, i1, i2)] =
            ...
            (-FDPart3tmp11 * lambdaU0 + FDPart3tmp127 * (FDPart3tmp286 + FDPart3tmp406) + FDPart3tmp140 * FDPart3tmp360 * FDPart3tmp68 +
             ...
             FDPart3tmp244 * FDPart3tmp396 - 4.0F / 3.0F * FDPart3tmp245 * FDPart3tmp59 - FDPart3tmp247 * FDPart3tmp395 +
        ...
        rhs_gfs[IDX4(LAMBDAU2GF, i0, i1, i2)] =
            ...
            (FDPart3tmp113 * FDPart3tmp460 + FDPart3tmp127 * FDPart3tmp438 + FDPart3tmp138 * FDPart3tmp360 * FDPart3tmp68 +
             FDPart3tmp164 * FDPart3tmp432 - FDPart3tmp17 * lambdaU0 + FDPart3tmp190 * FDPart3tmp455 - 4.0F / 3.0F * FDPart3tmp244 * FDPart3tmp53 -
        ...
        rhs_gfs[IDX4(TRKGF, i0, i1, i2)] =
            ...
            FDPart3tmp66 * FDPart3tmp70 * (-FDPart3tmp95 * alpha_dD0 + FDPart3tmp97) + (1.0F / 3.0F) * alpha * ((trK) * (trK)) + trK_dupD0 * vetU0;
