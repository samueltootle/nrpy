...
class base_simple_loop:
    ...
    def __init__(
        ...
        if enable_rfm_precompute:
            ...
            self.rfmp = rfm_precompute.ReferenceMetricPrecompute(CoordSystem, fp_type=fp_type)
        ...
        self.prefix_loop_with = ["", self.read_rfm_xx_arrays[2], self.read_rfm_xx_arrays[1]]
