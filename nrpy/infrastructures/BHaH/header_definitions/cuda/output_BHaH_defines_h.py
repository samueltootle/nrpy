"""
Construct BHaH_defines.h and gpu_definess from data registered to griddata_commondata, CodeParameters, and NRPyParameters.
...
def generate_declaration_str(decl_dict: Dict[str,Dict[str, str]], prefix: str = "") -> str:
    """
...
class output_BHaH_gpu_defines_h:
    ...
    def __init__(
        self,
        project_dir: str,
        additional_declarations_dict: Union[Dict[str, Dict[str,str]], None] = None,
...
"""
        ...
        # FIXME This device storage is only needed by some problems
...
//    DO NOT EDIT THIS FILE BY HAND.\n\n"""
        ...
        if self.additional_decl_dict:
            ...
            self.file_output_str += generate_declaration_str(self.additional_decl_dict, prefix="extern")
...
#endif
"""
        self.file_output_str = clang_format(self.file_output_str, clang_format_options=self.clang_format_options)
        self.write_to_file()
...
class output_init_gpu_defines_h:
    r"""
    Generate and write to file the BHaH_init_gpu_defines.h file.
    ...
    def __init__(
        ...
        self.clang_format_options = clang_format_options
        self.filename = "BHaH_init_gpu_defines.h"
