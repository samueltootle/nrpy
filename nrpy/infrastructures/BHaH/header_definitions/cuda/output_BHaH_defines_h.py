...
class output_BHaH_gpu_defines_h:
    ...
    def __init__(
        self,
        project_dir: str,
        additional_declarations_str: Union[str, None] = None,
        ...
        self.additional_decl_str = additional_declarations_str
...
"""
        ...
        # FIXME This is only needed by some problems
        if evolved_variables_list:
            self.decl_str += r"extern REAL* d_gridfunctions_wavespeed;\n"
            self.decl_str += r"extern REAL* d_gridfunctions_f_infinity;"
...
//    DO NOT EDIT THIS FILE BY HAND.\n\n"""
        ...
        if self.additional_decl_str:
            self.vfile_output_str += "\n\n// Additional Declarations\n" + self.additional_decl_str
