...
class output_BHaH_gpu_defines_h:
  ...
  >>> print(par.glb_code_params_dict)  
  >>> project_dir = Path("/tmp", "tmp_BHaH_defines_h")
  >>> output_BHaH_gpu_defines_h(project_dir)
  """
  def __init__(
    self,
    project_dir: str,
    ...
    self.numgrids = par.glb_params_dict.keys()
    # print(self.numgrids)
    ...
    if evolved_variables_list:
      self.output_str += r"extern REAL* d_gridfunctions_wavespeed;\n"
      self.output_str += r"extern REAL* d_gridfunctions_f_infinity;"
