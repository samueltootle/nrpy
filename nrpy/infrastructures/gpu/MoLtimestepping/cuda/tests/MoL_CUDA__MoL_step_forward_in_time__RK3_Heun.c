...
__global__ static void rk_substep_1_gpu(const size_t streamid, REAL *restrict k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs,
  ...
  for (int i = tid0; i < Ntot; i += stride0) {
    ...
    k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs[i] = RK_Rational_1_3 * dt * k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfsL + y_n_gfsL;
  }
}
...
__global__ static void rk_substep_2_gpu(const size_t streamid, REAL *restrict k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs,
  ...
  for (int i = tid0; i < Ntot; i += stride0) {
    ...
    k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs[i] =
        RK_Rational_1_4 * y_n_gfsL + RK_Rational_3_4 * k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfsL;
    k2_or_y_nplus_a32_k2_gfs[i] = RK_Rational_2_3 * dt * k2_or_y_nplus_a32_k2_gfsL + y_n_gfsL;
  }
}
 ...
 */
static void rk_substep_2(params_struct *restrict params, REAL *restrict k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs, REAL *restrict y_n_gfs,
                         REAL *restrict k2_or_y_nplus_a32_k2_gfs, const REAL dt) {
  const int Nxx_plus_2NGHOSTS0 = params->Nxx_plus_2NGHOSTS0;
  const int Nxx_plus_2NGHOSTS1 = params->Nxx_plus_2NGHOSTS1;
  const int Nxx_plus_2NGHOSTS2 = params->Nxx_plus_2NGHOSTS2;
  const int Ntot = Nxx_plus_2NGHOSTS0 * Nxx_plus_2NGHOSTS1 * Nxx_plus_2NGHOSTS2 * NUM_EVOL_GFS;
...
__global__ static void rk_substep_3_gpu(const size_t streamid, REAL *restrict k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfs,
  ...
  for (int i = tid0; i < Ntot; i += stride0) {
    ...
    const REAL y_n_gfsL = y_n_gfs[i];
    static constexpr REAL RK_Rational_3_4 = 3.0 / 4.0;
    y_n_gfs[i] = RK_Rational_3_4 * dt * y_n_gfsL + k1_or_y_nplus_a21_k1_or_y_nplus1_running_total_gfsL;
  }
}
