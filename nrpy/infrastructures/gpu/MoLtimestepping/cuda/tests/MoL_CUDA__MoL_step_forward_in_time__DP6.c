...
__global__ static void rk_substep_7_gpu(const size_t streamid, REAL *restrict k1_gfs, REAL *restrict k2_gfs, REAL *restrict k3_gfs,
  ...
  for (int i = tid0; i < Ntot; i += stride0) {
    ...
    const REAL k6_gfsL = k6_gfs[i];
    const REAL y_n_gfsL = y_n_gfs[i];
    static constexpr REAL RK_Rational_5610201_14158144 = 5610201.0 / 14158144.0;
    static constexpr REAL RK_Rational_424325_205632 = 424325.0 / 205632.0;
    static constexpr REAL RK_Rational_2945_1232 = 2945.0 / 1232.0;
    static constexpr REAL RK_Rational_376225_454272 = 376225.0 / 454272.0;
    static constexpr REAL RK_Rational_465467_266112 = 465467.0 / 266112.0;
    static constexpr REAL RK_Rational_10513573_3212352 = 10513573.0 / 3212352.0;
    next_y_input_gfs[i] = RK_Rational_10513573_3212352 * dt * k4_gfsL - RK_Rational_2945_1232 * dt * k2_gfsL +
                          RK_Rational_376225_454272 * dt * k6_gfsL - RK_Rational_424325_205632 * dt * k5_gfsL +
                          RK_Rational_465467_266112 * dt * k1_gfsL - RK_Rational_5610201_14158144 * dt * k3_gfsL + y_n_gfsL;
  }
}
 ...
 */
static void rk_substep_7(params_struct *restrict params, REAL *restrict k1_gfs, REAL *restrict k2_gfs, REAL *restrict k3_gfs, REAL *restrict k4_gfs,
                         REAL *restrict k5_gfs, REAL *restrict k6_gfs, REAL *restrict y_n_gfs, REAL *restrict next_y_input_gfs, const REAL dt) {
  const int Nxx_plus_2NGHOSTS0 = params->Nxx_plus_2NGHOSTS0;
  const int Nxx_plus_2NGHOSTS1 = params->Nxx_plus_2NGHOSTS1;
  const int Nxx_plus_2NGHOSTS2 = params->Nxx_plus_2NGHOSTS2;
...
__global__ static void rk_substep_8_gpu(const size_t streamid, REAL *restrict k1_gfs, REAL *restrict k3_gfs, REAL *restrict k4_gfs,
  ...
  for (int i = tid0; i < Ntot; i += stride0) {
    ...
    const REAL y_n_gfsL = y_n_gfs[i];
    static constexpr REAL RK_Rational_37_1120 = 37.0 / 1120.0;
    static constexpr REAL RK_Rational_1_10 = 1.0 / 10.0;
    static constexpr REAL RK_Rational_61_864 = 61.0 / 864.0;
    static constexpr REAL RK_Rational_1375_5408 = 1375.0 / 5408.0;
    static constexpr REAL RK_Rational_1375_7344 = 1375.0 / 7344.0;
    static constexpr REAL RK_Rational_16807_146016 = 16807.0 / 146016.0;
    static constexpr REAL RK_Rational_98415_321776 = 98415.0 / 321776.0;
    y_n_gfs[i] = RK_Rational_1375_5408 * dt * k6_gfsL + RK_Rational_1375_7344 * dt * k5_gfsL + RK_Rational_16807_146016 * dt * k4_gfsL +
                 RK_Rational_1_10 * dt * k8_gfsL - RK_Rational_37_1120 * dt * k7_gfsL + RK_Rational_61_864 * dt * k1_gfsL +
                 RK_Rational_98415_321776 * dt * k3_gfsL + y_n_gfsL;
  }
}
 ...
 */
static void rk_substep_8(params_struct *restrict params, REAL *restrict k1_gfs, REAL *restrict k3_gfs, REAL *restrict k4_gfs, REAL *restrict k5_gfs,
                         REAL *restrict k6_gfs, REAL *restrict k7_gfs, REAL *restrict k8_gfs, REAL *restrict y_n_gfs, const REAL dt) {
  const int Nxx_plus_2NGHOSTS0 = params->Nxx_plus_2NGHOSTS0;
  const int Nxx_plus_2NGHOSTS1 = params->Nxx_plus_2NGHOSTS1;
  const int Nxx_plus_2NGHOSTS2 = params->Nxx_plus_2NGHOSTS2;
  const int Ntot = Nxx_plus_2NGHOSTS0 * Nxx_plus_2NGHOSTS1 * Nxx_plus_2NGHOSTS2 * NUM_EVOL_GFS;
...
void MoL_step_forward_in_time(commondata_struct *restrict commondata, griddata_struct *restrict griddata) {
  ...
  for (int grid = 0; grid < commondata->NUMGRIDS; grid++) {
    ...
    rk_substep_7(params, k1_gfs, k2_gfs, k3_gfs, k4_gfs, k5_gfs, k6_gfs, y_n_gfs, next_y_input_gfs, commondata->dt);
    if (strncmp(commondata->outer_bc_type, "extrapolation", 50) == 0)
      apply_bcs_outerextrap_and_inner(commondata, params, bcstruct, next_y_input_gfs);
  }
  // -={ END k7 substep }=-
  ...
  for (int grid = 0; grid < commondata->NUMGRIDS; grid++) {
    ...
    rk_substep_8(params, k1_gfs, k3_gfs, k4_gfs, k5_gfs, k6_gfs, k7_gfs, k8_gfs, y_n_gfs, commondata->dt);
    if (strncmp(commondata->outer_bc_type, "extrapolation", 50) == 0)
